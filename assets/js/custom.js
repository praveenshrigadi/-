...
str+='<a href="blog-single.php?id='+value.id+'">';
str+='<img src="admin/blog-img/'+value.image+'" alt="'+value.name_title+'">';
str+='</a>';
str+='</div>';
str+='<div class="product_info">';
str+='<h6 class="product_title" alt="Shree Ganesh Brass Idol"><a href="blog-single.php?id='+value.id+'">'+value.name_title+'</a></h6>';
str+='<a href="blog-single.php?id='+value.id+'"><div class="product_desc" style=" display: -webkit-box;-webkit-line-clamp: 4;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;">'+value.content+'</div></a>';
str+='</div>';
str+='</div>';
str+='</div>';
...
$("#message").text('Code Does not Match');
    ...
    *===================================*/
	...
	$(document).on("click","#OffPayment",function(){
