...
$imageFileType = strtolower(pathinfo($targetFile, PATHINFO_EXTENSION));
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO `category`( `name`, `category_description`, `img`, `icon`, `meta_title`, `meta_keyword`, `meta_description`) VALUES
                    ('$name','$Description','$imageFileName','$Icon','$Meta_Title','$Meta_Keywords','$Meta_Description')";
