        ...
        success: function (data) {
            ...
            var reportTable = $('#Product_List').DataTable({
                ...
                columns: [
					...
					"data": "Product_ID",
					 "render": function (data, type, full, meta) {
                            return '<i data-id=' + data + ' id="Options" class="fa fa-edit text-primary" style="cursor:pointer" title="Making Option"></i>';
                        }
					},{ 
					"data": "Product_ID",
					 "render": function (data, type, full, meta) {
...
$(document).on('click', '#Edit', function() {
	  var id = $(this).attr("data-id");
	  window.location.href= url + "admin/update-product.php?id="+id;
});

$(document).on('click', '#Options', function() {
	  var id = $(this).attr("data-id");
	  window.location.href= url + "admin/add-options.php?id="+id;
});

$(document).on('click', '#Image', function() {
	  var id = $(this).attr("data-id");
	  window.location.href= url + "admin/product-image.php?id="+id;
});
...
$(document).on('click', '#delete', function(){
		...
		{
			$.ajax({
				url:url + "/admin/script/delete_product.php",
				method:"POST",
				data:{id:id},
				success:function(data){
			var obj = jQuery.parseJSON(data);
