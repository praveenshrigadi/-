                            ...
                            <form id="MainCatForm">
								...
								<div class="input-group col-md-12 col-12 mb-3">
                                    ...
                                    <div class="input-group col-md-12 col-12 mb-3">
									 ...
									 <div class="input-group col-md-12 col-12 mb-3">
                                        <label for="Icon" class="col-md-12 col-12">Icon<span class="text-danger"></span></label>
                                        <input type="text" name="Icon" class="form-control" placeholder="Main Category Icon">
                                    </div>
									<div class="input-group col-md-12 col-12 mb-3">
